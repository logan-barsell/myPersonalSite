...
const Footer = () => {
    ...
    return (
        <nav className="footer navbar navbar-expand-md navbar-light bg-light rounded-top">
            <div 
            ...
            >
                ...
                <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-slack" viewBox="0 0 16 16">
